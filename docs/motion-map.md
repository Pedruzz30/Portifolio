...
- `css/layout/ocean-background.css`: camadas globais animadas do `body`.
...
| `currentDrift1`, `currentDrift2` | `.about::before`, `.about-shell::before` | about | secao | `about-current-drift-primary/secondary` em `about.css` |
